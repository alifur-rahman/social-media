                ...
                <div class="row align-items-center">
                        ...
                        <div class="header-top-navigation">
                            <nav>
                                <ul>
                                            ...
                                            <ul class="dropdown-msg-list">
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <div class="msg-content notification-content">
                                                        <a href="profile.php">Robert Faul</a>,
                                                        <a href="profile.php">william jhon</a>
                                                ...
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <!-- message content start -->
                                                    <div class="msg-content notification-content">
                                                        <a href="profile.php">Robert mushkil</a>,
                                                        <a href="profile.php">Terry jhon</a>
                                                ...
                                                <li class="msg-list-item d-flex justify-content-between">
                                                    ...
                                                    <!-- message content start -->
                                                    <div class="msg-content notification-content">
                                                        <a href="profile.php">Horijon Mbala</a>,
                                                        <a href="profile.php">Bashu jhon</a>
                                    ...
                                    <li class=""><a href="club.php">Clubs</a></li>
                                </ul>
                            </nav>
                        </div>
                        <!-- header top navigation start -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="brand-logo text-center">
                            <a href="index.php">
                                <img src="assets/images/logo/logo.png" width="140px" alt="brand logo">
                            </a>
                        </div>
                        <!-- brand logo end -->
                    </div>
                                    ...
                                    <div class="profile-dropdown">
                                        ...
                                        <div class="profile-body">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="logout.php"><i class="flaticon-unlock"></i>Sing out</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
